...
export default function PageTemplate({ page, mainMenu,footerMenu,footerContent,isiContent, hrefLang, preview }) {
	console.log(isiContent,'isiContent')
	...
	return (
		<Layout preview={preview} mainMenu={mainMenu} footerContent={footerContent} footerMenu={footerMenu} isiContent={isiContent}>
			<NextSeo
