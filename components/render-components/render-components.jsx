...
export const RenderComponents = ({ components }) => {
	console.log(components, "HelpfulDots");
	return (
		<div className="main">
			{components.map((component) => {
				if (component.type == 'paragraph--hero') {
					...
					return <Section key={component.id} components={component} />;
				}
				else if (component.type == 'paragraph--left_title') {
					return <LeftTitle key={component.id} components={component} />;
				}
				else if (component.type == 'paragraph--biosimilar') {
					return <BiosiliarCard key={component.id} components={component} />;
				}
				else if (component.type == 'paragraph--center_title') {
					return <CenterCard key={component.id} components={component} />;
				}
