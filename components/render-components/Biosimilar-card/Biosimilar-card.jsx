				...
				<Row>
					...
					<Col lg={6} xs={12}>
						{component.field_biosimilar_card.map((item) => (
							<div
								key={item.id}
								className={styles['outstanding-biosimilar-right']}
							>
								<div
									...
									dangerouslySetInnerHTML={{
										__html: item.field_left_content_card.processed,
									}}
								></div>
								<div
									className={styles['center']}
									data-aos="fade-right"
									data-aos-delay={`${item.field_center_delay}`}
									data-aos-duration="500"
								>
									<Image
										width={55}
										...
										src={
											IMAGE_URL +
											item.field_center_arrow.field_media_image.uri.url
										}
										alt="round-arrow"
									/>
								</div>
								<div
									...
									data-aos="fade-right"
									data-aos-delay={`${item.field_right_delay}`}
									data-aos-duration="500"
									dangerouslySetInnerHTML={{
										__html: item.field_right_content_card.processed,
									}}
								></div>
							</div>
						))}
